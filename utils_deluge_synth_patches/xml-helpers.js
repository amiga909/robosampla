...
exports.getMidiNoFromFilenameLoopop = function (fileName) {
  ...
  if (underscoreIndex === -1) {
    // If no underscore found, try to parse the whole name as a number
    return parseInt(name, 10) || 0;
  }
  const noteNumberStr = name.substring(0, underscoreIndex);
  let midiNo = parseInt(noteNumberStr, 10) || 0;
